...
public class InsertValues {
    ...
    public static void BigTournoiExemple() {
        ...
        try {
            ...
            // *
            TournoiModele t = new TournoiModele(66, "Big tournoi", "20/12/2023", "17/01/2024", Notoriete.INTERNATIONAL,
                    EtatTournoi.FERME);

            // 4 équipes
            Equipe e = new Equipe(0, "Maxence Maury-Balliteam", Nationalite.FR, Disposition.DISPOSEE, 3, 0);
            EquipeDAO.getInstance().add(e);
            Equipe e2 = new Equipe(1, "Ibrateam Zoubairov", Nationalite.FR, Disposition.DISPOSEE, 1, 0);
            EquipeDAO.getInstance().add(e2);
            Equipe e3 = new Equipe(2, "Equipema Rasoanaivo", Nationalite.FR, Disposition.DISPOSEE, 2, 0);
            EquipeDAO.getInstance().add(e3);
            Equipe e4 = new Equipe(3, "Stuarteam Barthe", Nationalite.FR, Disposition.DISPOSEE, 4, 0);
            EquipeDAO.getInstance().add(e4);

            TournoiDAO.getInstance().add(t);

            Joueur je11 = new Joueur(0, "Marie", e.getIdEquipe());
            JoueurDAO.getInstance().add(je11);
            Joueur je12 = new Joueur(1, "Milo", e.getIdEquipe());
            JoueurDAO.getInstance().add(je12);
            Joueur je13 = new Joueur(2, "Mouna", e.getIdEquipe());
            JoueurDAO.getInstance().add(je13);
            Joueur je14 = new Joueur(3, "Maxime", e.getIdEquipe());
            JoueurDAO.getInstance().add(je14);
            Joueur je15 = new Joueur(4, "Meredith", e.getIdEquipe());
            JoueurDAO.getInstance().add(je15);

            Joueur je21 = new Joueur(5, "Ilona", e2.getIdEquipe());
            JoueurDAO.getInstance().add(je21);
            Joueur je22 = new Joueur(6, "Ingrid", e2.getIdEquipe());
            JoueurDAO.getInstance().add(je22);
            Joueur je23 = new Joueur(7, "Isaac", e2.getIdEquipe());
            JoueurDAO.getInstance().add(je23);
            Joueur je24 = new Joueur(8, "Icare", e2.getIdEquipe());
            JoueurDAO.getInstance().add(je24);
            Joueur je25 = new Joueur(9, "Ines", e2.getIdEquipe());
            JoueurDAO.getInstance().add(je25);

            Joueur je31 = new Joueur(10, "Enzo", e3.getIdEquipe());
            JoueurDAO.getInstance().add(je31);
            Joueur je32 = new Joueur(11, "Emile", e3.getIdEquipe());
            JoueurDAO.getInstance().add(je32);
            Joueur je33 = new Joueur(12, "Emma", e3.getIdEquipe());
            JoueurDAO.getInstance().add(je33);
            Joueur je34 = new Joueur(13, "Lea", e3.getIdEquipe());
            JoueurDAO.getInstance().add(je34);
            Joueur je35 = new Joueur(14, "Leo", e3.getIdEquipe());
            JoueurDAO.getInstance().add(je35);

            Joueur j1 = new Joueur(15, "Suzie", e4.getIdEquipe());
            JoueurDAO.getInstance().add(j1);
            Joueur j2 = new Joueur(16, "Salem", e4.getIdEquipe());
            JoueurDAO.getInstance().add(j2);
            Joueur j3 = new Joueur(17, "Sophie", e4.getIdEquipe());
            JoueurDAO.getInstance().add(j3);
            Joueur j4 = new Joueur(18, "Samy", e4.getIdEquipe());
            JoueurDAO.getInstance().add(j4);
            Joueur j5 = new Joueur(19, "Soul", e4.getIdEquipe());

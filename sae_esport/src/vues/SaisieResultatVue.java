...
public class SaisieResultatVue extends CustomJFrame {
    ...
    public SaisieResultatVue() throws Exception {
        ...
        CustomJPanel panelMiddleFinalEquipe = new CustomJPanel(new EmptyBorder(0, 0, 0, 0),
        ...
        for (Match match : this.tournoi.getMatchs()) {
            ...
            if (!match.IsItFinale()) {
                ...
                CustomJPanel MatchCustomJPanel = new CustomJPanel(new EmptyBorder(0, 0, 0, 0),
                ...
                // Panel Equipe Liste
                CustomJPanel MatchEquipeListJPanel = new CustomJPanel(new EmptyBorder(10, 10, 10, 10),
        ...
        CustomJPanel panelMiddleBottom = new CustomJPanel(new EmptyBorder(10, 10, 10, 10),
        ...
        // Panel bottom
        CustomJPanel panelBottom = new CustomJPanel(new EmptyBorder(10, 10, 0, 10),
                new FlowLayout(FlowLayout.CENTER, 5, 5));

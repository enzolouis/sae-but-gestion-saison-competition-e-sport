...
public class Palette {
	...
	static {
		...
		try {
			loadedFont = Font.createFont(Font.TRUETYPE_FONT, new File("fonts/BeaufortforLOL-Heavy.ttf"))
					.deriveFont(12f);
	...
	public static final ImageIcon LOGO = new ImageIcon(
			new ImageIcon(Palette.class.getClassLoader().getResource("assets/app-logo.png")).getImage()

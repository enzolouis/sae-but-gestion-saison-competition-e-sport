...
public class CustomJPasswordField extends JPasswordField {
    ...
    /**
     * Ryan GAUNAND <br>
     * Création d'un JTextField l'application automatique de la charte graphique de
     * l'application.
     *
     */
     ...
     * Ryan GAUNAND <br>
     * Création d'un JTextField avec la définition d'un texte de renseignement,
     * la définition du nombre de colonne pour le calcul de la taille voulus, de
     * bordure vide et
     * l'application automatique de la charte graphique de l'application.
     *
     * @param Texte    de renseignement
    ...
    /**
     * Ryan GAUNAND <br>
     * Création d'un JTextField avec la définition de la taile, un texte de
     * renseignement et
     * l'application automatique de la charte graphique de l'application.
     *
     * @param Taille
    ...
    /**
     * Vérifie si la taille de la fenêtre corresponds aux valeurs de largeur et
     * hauteur donné
     * 
     * @param largeur
     * @param hauteur

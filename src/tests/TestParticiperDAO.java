...
public class TestParticiperDAO {
    ...
    public void beforeTests() throws Exception {
        ...
        EquipeDAO.getInstance().add(equipeTest);
        EquipeDAO.getInstance().add(equipeTest2);
    }
    ...
    public void testDelete() throws Exception {
        ...
        assertEquals(Optional.empty(), ParticiperDAO.getInstance().getByIdTournoiIdEquipe(participer.getIdEquipe(),
                participer.getIdTournoi()));
        DBConnection.getInstance().rollback();
    }

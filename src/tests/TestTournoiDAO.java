...
public class TestTournoiDAO {
    ...
    public void testRecupererMatch() throws Exception {
        ...
        Equipe e = new Equipe(0, "Maxence Maury-Balliteam", Nationalite.FR, Disposition.DISPOSEE, 3, 1000);
        EquipeDAO.getInstance().add(e);
        Equipe e2 = new Equipe(1, "Ibrateam Zoubairov", Nationalite.FR, Disposition.DISPOSEE, 1, 2300);

...
public class Palette {
    ...
    static {
        ...
        try {
            loadedFont = Font.createFont(Font.TRUETYPE_FONT, new File("src/resources/fonts/Montserrat-Medium.ttf"))
                    .deriveFont(11f);
    ...
    public static final ImageIcon OEIL_INVISIBLE_ICON = new ImageIcon(
            new ImageIcon(Palette.class.getClassLoader().getResource("resources/assets/hidden-eye.png")).getImage()
                    .getScaledInstance(30, 30, java.awt.Image.SCALE_SMOOTH));

    public static final ImageIcon OEIL_VISIBLE_ICON = new ImageIcon(
            new ImageIcon(Palette.class.getClassLoader().getResource("resources/assets/visible-eye.png")).getImage()
                    .getScaledInstance(30, 30, java.awt.Image.SCALE_SMOOTH));

    public static final ImageIcon ACCOUNT_LOGO = new ImageIcon(
            new ImageIcon(Palette.class.getClassLoader().getResource("resources/assets/account.png")).getImage()
                    .getScaledInstance(30, 30, java.awt.Image.SCALE_SMOOTH));

    public static final ImageIcon LOGO = new ImageIcon(
            new ImageIcon(Palette.class.getClassLoader().getResource("resources/assets/app-logo-header.png")).getImage()
                    .getScaledInstance(100, 100, java.awt.Image.SCALE_SMOOTH));

    public static final ImageIcon LOGO_LARGE = new ImageIcon(
            new ImageIcon(Palette.class.getClassLoader().getResource("resources/assets/app-logo-windows.png")).getImage());


    public static final ImageIcon MINIMIZE = new ImageIcon(
            new ImageIcon(Palette.class.getClassLoader().getResource("resources/assets/minimize.png")).getImage()
                    .getScaledInstance(20, 20, java.awt.Image.SCALE_SMOOTH));

    public static final ImageIcon CLOSE = new ImageIcon(
            new ImageIcon(Palette.class.getClassLoader().getResource("resources/assets/close.png")).getImage()
                    .getScaledInstance(20, 20, java.awt.Image.SCALE_SMOOTH));

    public static final ImageIcon ADMIN = new ImageIcon(
            new ImageIcon(Palette.class.getClassLoader().getResource("resources/assets/app-logo-admin.png")).getImage()
                    .getScaledInstance(20, 20, java.awt.Image.SCALE_SMOOTH));

    public static final ImageIcon ARBITRE = new ImageIcon(
            new ImageIcon(Palette.class.getClassLoader().getResource("resources/assets/app-logo-referee.png")).getImage()
                    .getScaledInstance(20, 20, java.awt.Image.SCALE_SMOOTH));

    public static final ImageIcon LOGINIMAGE = new ImageIcon(
            new ImageIcon(Palette.class.getClassLoader().getResource("resources/assets/login-image.jpg")).getImage()
                    .getScaledInstance(426, 325, java.awt.Image.SCALE_SMOOTH));
    
    public static final ImageIcon CONNECT = new ImageIcon(
            new ImageIcon(Palette.class.getClassLoader().getResource("resources/assets/connect.png")).getImage()
                    .getScaledInstance(20, 20, java.awt.Image.SCALE_SMOOTH));

    public static final ImageIcon STATS = new ImageIcon(
            new ImageIcon(Palette.class.getClassLoader().getResource("resources/assets/stats-page.png")).getImage()
